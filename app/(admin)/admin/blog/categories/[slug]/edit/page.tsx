// ============================================================================
// File: components/category/editcategoryform.tsx
// Purpose: Inline category editor for the categories list. Display mode
//          shows label + accent exactly as the page did; Edit switches the
//          row to inputs with Save/Cancel, calling updateCategory bound to
//          the category id. Exits edit mode on success.
// Type: Client Component ("use client")
// ============================================================================
"use client";

import { useActionState, useEffect, useState } from "react";
import { updateCategory, type EditCategoryState } from "@/app/api/category/actions";
    ...
    return (
        <form action={formAction} className="flex flex-wrap items-center gap-2">
            <input name="label" defaultValue={label} required
                placeholder="Label" className={`${inputClass} w-36`} />
            <input name="accent" defaultValue={accent}
                placeholder="Accent phrase" className={`${inputClass} w-36`} />
