...
export default async function ProfilePage() {
    ...
    const [user, deviceCount, pendingCount, postCount, caseStudyCount] = await Promise.all([
        ...
        prisma.caseStudy.count({ where: { authorId: userId } }),
    ]);
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                ...
                <section className="flex flex-col rounded-lg border border-neutral-200 bg-white p-6">
                    ...
                    <div className="mt-5 grid grid-cols-2 gap-3">
                        <Field label="Posts written" value={String(postCount)} />
                        <Field label="Case studies" value={String(caseStudyCount)} />
                    </div>
