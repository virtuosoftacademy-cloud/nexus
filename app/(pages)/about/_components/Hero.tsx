...
function Hero() {
    return (
        <>
            <section id="hero" className="relative overflow-hidden flex flex-col min-h-96 md:min-h-screen -z-20">
                ...
                <div className="relative top-30 left-8 md:top-40 md:left-10 xl:left-15 bg-accent/90 text-foreground flex flex-col z-50 max-w-2xs md:max-w-lg px-8 py-4 md:px-6 md:py-10 border-b-4 border-primary">
                    ...
                    <p className="text-foreground/80 font-heading pt-5 max-w-sm text-sm md:text-lg">We introduce financial structure where complexity has begun to outpace control. For businesses that intend to scale responsibly not reactively.</p>
                </div>
