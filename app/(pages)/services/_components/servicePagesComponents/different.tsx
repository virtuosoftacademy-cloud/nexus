    ...
    return (
        <section className="py-14 md:py-20 px-4 flex justify-center flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 items-center">
                {items?.map((item) =>
                    <Card key={item.id} className="group rounded-none border-2 border-primary w-full md:w-[32em] h-20 px-18 py-10 bg-primary/5 hover:bg-primary transition-all duration-400 text-center flex justify-center">
