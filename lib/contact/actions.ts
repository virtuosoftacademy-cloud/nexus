...
export async function sendContactMessage(
    ...
    if (!values.interestedIn) {
        fieldErrors.interestedIn = "Please choose what this is about.";
    } else if (!INTEREST_OPTIONS.includes(values.interestedIn)) {
        fieldErrors.interestedIn = "Please choose one of the listed options.";
    }
